...
import { ReissuePickupCodeService } from './application/reissue-pickup-code.service.js';
...
import { PICKUP_CODE_REISSUE_LIMITER } from './domain/pickup-code-reissue-limiter.js';
...
import { RedisPickupCodeReissueLimiter } from './infrastructure/redis-pickup-code-reissue-limiter.js';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: PACKAGE_LISTING_REPOSITORY,
    ...
    {
      provide: PICKUP_CODE_REISSUE_LIMITER,
      useClass: RedisPickupCodeReissueLimiter,
    },
  ],
})
